...
def wishMe():
    ...
    TTS.speak_Print("I am Harris Sir. Please tell me how may I help you") 
...
def screenshot():
    name_img = tt.time()
    name_img = f'C:/DSA/Shadow-Voice_Assistant/Shadow-Voice_Assistant/ShadowGui/features/screenshots/{name_img}.png'
...
def InstaDownload():
    ...
    if "yes" in condition:
        ...
        os.chdir(r"C:\DSA\Shadow-Voice_Assistant\Shadow-Voice_Assistant\ShadowGui\features\secure\InstaImage")
...
def appendnote():
    ...
    file = open(r'C:\DSA\Shadow-Voice_Assistant\Shadow-Voice_Assistant\ShadowGui\features\remeberNote.txt', 'a')
...
def writenote():
    note = TTS.takeCommand()
    file = open(r'C:\DSA\Shadow-Voice_Assistant\Shadow-Voice_Assistant\ShadowGui\features\remeberNote.txt', 'w')
    strTime = datetime.datetime.now().strftime("%m/%d/%Y, %H:%M:%S")
    file.write(strTime)
    file.write(" :- ")
    file.write(note)
...
def shownote():
    file = open(r"C:\DSA\Shadow-Voice_Assistant\Shadow-Voice_Assistant\ShadowGui\features\remeberNote.txt", "r")
